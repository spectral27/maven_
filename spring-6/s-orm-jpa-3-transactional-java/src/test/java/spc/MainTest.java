...
public class MainTest {
    ...
    public void mainTest() {
        JavaObjectService service = applicationContext.getBean(JavaObjectService.class);
        JavaObject javaObject = new JavaObject();
        javaObject.setVendor("JUnit");
        javaObject.setVersion("5.9.2");
        service.insertObject(javaObject);
        List<JavaObject> javaObjects = service.selectObjects();
