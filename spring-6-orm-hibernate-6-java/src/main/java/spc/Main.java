...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        hibernate.setVersion("6.2.2");

        repository.insertJavaObject(hibernate);

        JavaObject toDelete = new JavaObject();
        toDelete.setId(99);
        toDelete.setVendor("To Delete");
        toDelete.setVersion("1.0.0");

        repository.insertJavaObject(toDelete);

        JavaObject updateJava = new JavaObject();
